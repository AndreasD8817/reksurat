        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
            <div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <input type="text" id="agenda_urut" name="agenda_urut" value="<?php echo $next_nomor_urut; ?>" class="w-24 px-4 py-3 rounded-xl border border-gray-300 text-center" placeholder="No. Urut">
                    <span class="text-gray-500 pt-2">/</span>
                    <!-- Dropdown Tahun -->
                    <select id="tahun_penomoran_masuk" name="tahun_penomoran" class="w-28 px-4 py-3 rounded-xl border border-gray-300 bg-white" required>
