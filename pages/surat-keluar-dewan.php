...
function handleFileUpload($fileInputName, $subDirectory) {
    if (isset($_FILES[$fileInputName]) && $_FILES[$fileInputName]['error'] === UPLOAD_ERR_OK) {
        ...
        // UBAH: Sesuaikan sub-direktori untuk file dewan
...
<div id="form-keluar-dewan-container" class="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-xl p-6 animate-fade-in border border-blue-100 transition-all duration-500">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="number" id="nomor_urut_keluar_dewan" name="nomor_urut" class="w-full px-4 py-3 rounded-xl border border-gray-300 text-center" placeholder="No. Urut" required />
...
<div id="list-keluar-dewan-container" class="mt-8 bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-xl p-6 animate-fade-in border border-blue-100 transition-all duration-500">
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <form id="searchFormKeluarDewan" class="w-full md:w-96 relative">
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400"><i class="fas fa-search"></i></div>
                <input type="text" id="searchInputKeluarDewan" name="search" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl" placeholder="Ketik untuk mencari surat...">
            </div>
        </form>
    </div>
